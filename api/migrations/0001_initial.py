    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('S', 'Submitted'), ('P', 'Published'), ('H', 'Hidden'), ('A', 'Archived')], max_length=1)),
                ...
                ('director_email', models.CharField(blank=True, max_length=50, null=True)),
                ('director_mob', models.CharField(blank=True, max_length=20, null=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('badges', models.ManyToManyField(to='api.Badge')),
                ('follows', models.ManyToManyField(blank=True, to='api.Profile')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.profiletype')),
        ...
        migrations.AddField(
            model_name='movie',
            name='lan',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.movielanguage'),
        ),
        migrations.CreateModel(
            name='Judge',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('C', 'Created'), ('S', 'Success'), ('F', 'Failed')], max_length=1)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.awardtype')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
